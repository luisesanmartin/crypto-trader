...
def bs_buy_limit_order(amount, price, market_symbol, client_order_id=None, credentials=bs_credentials()):
    ...
    if client_order_id:
        payload['client_order_id'] = client_order_id
    url_path_query = f'/api/v2/buy/{market_symbol}/'
...
def bs_check_order_status(client_order_id, credentials=bs_credentials()):

    '''
    Checks the status of an order given its client order ID
    '''
    ...
    url_path_query = '/api/v2/order_status/'
...
def bs_cancel_order(client_order_id, credentials=bs_credentials()):

    '''
    Cancels an order given its client order ID
    '''
    ...
    url_path_query = '/api/v2/cancel_order/'
